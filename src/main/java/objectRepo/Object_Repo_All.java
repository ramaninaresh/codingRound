...
public interface Object_Repo_All {
String signInPage_Your_trip_link="Your trips";
String signInPage_SignIn_ID="SignIn";
String signInPage_SignIn_Button_ID="signInButton";
String signInPage_error_message_ID="errors1";
String Signin_Model_Iframe_xPath="//*[@id='modal_window']";


String Hotel_link_text="Hotels";
String Hotel_ID_localityTextBox="Tags";
String Hotel_ID_SearchButton="SearchHotelsButton";
...
String Date_Picker_Table="//*[@id='ui-datepicker-div']/div[1]/table/tbody";
}
